// Define a global variable to store the Swiper instance
var swiper;
...
function searchGames() {
    ...
    // Destroy the Swiper instance to stop swiping
    if (swiper) {
        swiper.destroy();
        swiper = null;
    }
...
// Initialize the Swiper outside the searchGames function
