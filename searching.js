function searchGames() {
    ...
    // Get the element containing <h2>IO Games</h2> and <h5 class="view-more">...</h5>
    ...
    if (resultsFound) {
        ...
        // Hide the <h2>IO Games</h2> and <h5 class="view-more">...</h5> section
        ioGamesSection.style.display = 'none';
    }
